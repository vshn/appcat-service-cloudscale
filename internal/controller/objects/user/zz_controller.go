...
import (
	...
	v1alpha1 "github.com/vshn/provider-jet-cloudscale/apis/objects/v1alpha1"
)
...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	r := managed.NewReconciler(mgr,
		...
		managed.WithExternalConnecter(tjcontroller.NewConnector(mgr.GetClient(), o.WorkspaceStore, o.SetupFn, o.Provider.Resources["cloudscale_objects_user"])),
