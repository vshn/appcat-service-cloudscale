...
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX := https://releases.hashicorp.com/terraform-provider-cloudscale/4.0.0
export TERRAFORM_NATIVE_PROVIDER_BINARY := terraform-provider-cloudscale_v4.0.0
...
IMAGES = provider-jet-cloudscale provider-jet-cloudscale-controller
